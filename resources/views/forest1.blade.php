...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" data-spy="scroll" data-target="#myScrollspy" data-offset="1">
    ...
    <div id="app">
                    ...
                    <ul class="navbar-nav navbar-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('beach') }}">Beach</a>
                                <a class="dropdown-item" href="{{ url('forest') }}">Forest</a>
                                <a class="dropdown-item" href="{{ url('hotspring') }}">Hotspring</a>
                            </div>
                        </li>
                        <!-- Contact Us -->
                        <li class="nav-item dropdown">
        ...
        <div class="container-fluid">
            <div class="row">
                <nav class="col-sm-3 col-4 sticky-top" id="myScrollspy">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                    <a class="nav-link" href="#why">Why Forest?</a>
                    </li>
                    <li class="nav-item">
